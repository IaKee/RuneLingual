...
public enum LangCodeSelectableList
{
    ...
    NORSK(
        ...
        true)
    */
    // TODO: add any new languages here
    ...
    @Inject
    LangCodeSelectableList(
            String langCode,
            String deeplCodeSrc,
            String deeplCodeTgt,
            int charWidth,
            int chatBoxCharWidth,
            boolean needCharImages,
            boolean swapMenuOptionAndTarget,
            boolean needInputOverlay,
            boolean needInputCandidateOverlay,
